...
const TodaysSpecials = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0, 64, 48, 0.7), rgba(0, 64, 48, 0.7)), url(${import.meta.env.BASE_URL}assets/todays-specials-bg.jpg)`, // ✅ updated
        ...
        <section className="relative py-12">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center overflow-hidden rounded-xl shadow-lg">
            ...
            <div className="md:w-1/2 w-full h-56 md:h-80">
              <img
                src={`${import.meta.env.BASE_URL}assets/${slides[current].image}`} // ✅ updated
