...
const recipes = [
  {
    ...
    img: "recipe1.jpg",
    description:
      "A rich and creamy Italian pasta dish made with eggs, cheese, pancetta, and pepper.",
  },
  {
    id: 2,
    name: "Grilled Salmon",
    img: "recipe2.jpg",
    description:
      "Perfectly grilled salmon fillets with lemon butter sauce for a light, healthy meal.",
  },
  {
    id: 3,
    ...
    img: "recipe3.jpg",
    description:
      "A flavorful South Asian rice dish with spiced chicken, saffron, and aromatic herbs.",
  },
];
...
const RecipeDetails = () => {
  ...
  if (!recipe) {
    return (
      <h2 className="text-center mt-10 text-red-500">Recipe not found!</h2>
    );
  }
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="md:w-1/2">
              <img
                src={`${import.meta.env.BASE_URL}assets/${recipe.img}`}
                alt={recipe.name}
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <p className="text-textdark">
                This recipe is a family favorite, offering rich flavors while
                being simple to prepare. You can experiment with herbs and
                spices to match your taste preferences. Perfect for dinner
                nights!
              </p>
            </div>
          </div>

          {/* Bottom Nutrients Section */}
          <div>
            <h3 className="text-2xl font-bold text-forest text-center">
              Nutritional Value
            </h3>
