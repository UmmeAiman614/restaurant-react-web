          ...
          <div className="bg-sand shadow-md p-8 flex flex-col justify-between rounded-2xl">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-6 justify-center">
                <a href="#" className="text-forest hover:text-teal"><Facebook /></a>
                <a href="#" className="text-forest hover:text-teal"><Twitter /></a>
                <a href="#" className="text-forest hover:text-teal"><Instagram /></a>
              </div>
            </div>
          </div>
