...
const extraPosts = [
  {
    ...
    img: `${import.meta.env.BASE_URL}assets/blog4.jpg`,
  },
  {
    id: 5,
    title: "Quick Breakfasts",
    desc: "Fast and healthy breakfast recipes for busy mornings.",
    img: `${import.meta.env.BASE_URL}assets/blog5.jpg`,
  },
  {
    id: 6,
    title: "Smoothie Ideas",
    desc: "Colorful smoothies packed with nutrients and flavor.",
    img: `${import.meta.env.BASE_URL}assets/blog6.jpg`,
  },
];

const recentPosts = [
  { id: 7, title: "10-Minute Meals", img: `${import.meta.env.BASE_URL}assets/blog7.jpg` },
  { id: 8, title: "Tips for Baking", img: `${import.meta.env.BASE_URL}assets/blog8.jpg` },
  { id: 9, title: "Vegan Cooking", img: `${import.meta.env.BASE_URL}assets/footer-post2.png` },
];
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {extraPosts.map((post) => (
                <div key={post.id} className="bg-sand rounded-xl shadow-md overflow-hidden">
                  <img
                    src={post.img}
                    alt={post.title}
                  ...
                  />
                  <div className="p-4">
                    <h3 className="text-lg font-semibold text-forest">{post.title}</h3>
                    <div className="w-12 h-1 bg-teal my-2 rounded"></div>
                    <p className="text-textdark text-sm">{post.desc}</p>
